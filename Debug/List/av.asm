...
_0x4:
	.DB  0x20
_0x0:
	.DB  0x25,0x64,0x0,0x44,0x69,0x76,0x69,0x64
	.DB  0x65,0x20,0x42,0x79,0x20,0x5A,0x65,0x72
	.DB  0x6F,0x21,0x0
_0x2000003:
	.DB  0x80,0xC0
...
; 0000 0057             sprintf(number_string, "%d", number2);
	LDI  R30,LOW(_number_string)
	LDI  R31,HIGH(_number_string)
	ST   -Y,R31
	ST   -Y,R30
	__POINTW1FN _0x0,0
	ST   -Y,R31
...
; 0000 005A             lcd_puts(number_string);
	LDI  R26,LOW(_number_string)
	LDI  R27,HIGH(_number_string)
	RCALL _lcd_puts
